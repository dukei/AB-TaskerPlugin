...
public final class Constants {
    ...
    public static final String LOG_TAG = "AB-TaskerPlugin"; //$NON-NLS-1$
     ...
     */
    public static final boolean IS_LOGGABLE = DEBUG;

    /**
     * Flag to enable runtime checking of method parameters.
     */
    public static final boolean IS_PARAMETER_CHECKING_ENABLED = DEBUG;

    /**
     * Flag to enable runtime checking of whether a method is called on the correct thread.
     */
    public static final boolean IS_CORRECT_THREAD_CHECKING_ENABLED = DEBUG;
